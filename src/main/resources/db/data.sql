insert into user_tb(username, password, email) values('ssar1', '1234', 'ssar1@nate.com');
insert into user_tb(username, password, email) values('cos1', '1234', 'cos1@nate.com');
